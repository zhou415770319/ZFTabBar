...
-(id)initWithImages:(NSMutableArray *)images SelectImages:(NSMutableArray *)selectImages LongTitles:(NSMutableArray *)longTitles titles:(NSMutableArray *)titles DesTitles:(NSMutableArray *)desTitles{
    if ([super init]) {
...
//    NSArray *ary = [NSArray arrayWithObjects:[UIColor redColor],[UIColor grayColor],[UIColor blackColor],[UIColor blueColor],[UIColor greenColor], nil];
    NSArray *textAry = self.desTitles;
...
- (void)changeLongViewSizeWithBtn:(ZFButton *)control
{
    ...
    control.imageView.frame = CGRectMake(xm_btnWidth / 3 - xm_imageWidth-20, xm_btnHeight /2 - xm_imageHeight/2, xm_imageWidth, xm_imageHeight);
...
//        NSArray *ary = [NSArray arrayWithObjects:[UIColor blueColor],[UIColor blueColor],[UIColor blueColor],[UIColor blueColor],[UIColor blueColor], nil];
...
//            [buttonNew setBackgroundColor:ary[i]];
            //        buttonX += 0;
            if (button == buttonNew) {
                buttonNew.titleLabel.text = self.longTitles[i];
...
//                }
            ...
            {
                buttonNew.titleLabel.text = self.titles[i];
